...
#include "appleproj_interfaces/msg/detail/simulation_state__rosidl_typesupport_fastrtps_c.h"
...
using _SimulationState__ros_msg_type = appleproj_interfaces__msg__SimulationState;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = appleproj_interfaces__msg__SimulationState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const appleproj_interfaces__msg__SimulationState * ros_message = static_cast<const appleproj_interfaces__msg__SimulationState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_appleproj_interfaces__msg__SimulationState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  appleproj_interfaces__msg__SimulationState * ros_message = static_cast<appleproj_interfaces__msg__SimulationState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_appleproj_interfaces__msg__SimulationState(cdr, ros_message);
}

static uint32_t _SimulationState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_appleproj_interfaces__msg__SimulationState(
...
static size_t _SimulationState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_appleproj_interfaces__msg__SimulationState(
