...
#include "appleproj_interfaces/msg/detail/inspection_image__rosidl_typesupport_fastrtps_c.h"
...
using _InspectionImage__ros_msg_type = appleproj_interfaces__msg__InspectionImage;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_appleproj_interfaces
bool cdr_serialize_appleproj_interfaces__msg__InspectionImage(
  const appleproj_interfaces__msg__InspectionImage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_appleproj_interfaces
bool cdr_deserialize_appleproj_interfaces__msg__InspectionImage(
  eprosima::fastcdr::Cdr & cdr,
  appleproj_interfaces__msg__InspectionImage * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_appleproj_interfaces
size_t get_serialized_size_appleproj_interfaces__msg__InspectionImage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InspectionImage__ros_msg_type * ros_message = static_cast<const _InspectionImage__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_appleproj_interfaces
size_t max_serialized_size_appleproj_interfaces__msg__InspectionImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = appleproj_interfaces__msg__InspectionImage;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_appleproj_interfaces
bool cdr_serialize_key_appleproj_interfaces__msg__InspectionImage(
  const appleproj_interfaces__msg__InspectionImage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_appleproj_interfaces
size_t get_serialized_size_key_appleproj_interfaces__msg__InspectionImage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _InspectionImage__ros_msg_type * ros_message = static_cast<const _InspectionImage__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_appleproj_interfaces
size_t max_serialized_size_key_appleproj_interfaces__msg__InspectionImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const appleproj_interfaces__msg__InspectionImage * ros_message = static_cast<const appleproj_interfaces__msg__InspectionImage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_appleproj_interfaces__msg__InspectionImage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  appleproj_interfaces__msg__InspectionImage * ros_message = static_cast<appleproj_interfaces__msg__InspectionImage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_appleproj_interfaces__msg__InspectionImage(cdr, ros_message);
}

static uint32_t _InspectionImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_appleproj_interfaces__msg__InspectionImage(
...
static size_t _InspectionImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_appleproj_interfaces__msg__InspectionImage(
...
static message_type_support_callbacks_t __callbacks_InspectionImage = {
...
static rosidl_message_type_support_t _InspectionImage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_InspectionImage,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, appleproj_interfaces, msg, InspectionImage)() {
  return &_InspectionImage__type_support;
}
