...
class Metaclass_GetPlanningScene_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from appleproj_interfaces.msg import PlanningScene
...
class GetPlanningScene_Response(metaclass=Metaclass_GetPlanningScene_Response):
    ...
    _fields_and_field_types = {
        'success': 'boolean',
        'scene': 'appleproj_interfaces/PlanningScene',
        'message': 'string',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['appleproj_interfaces', 'msg'], 'PlanningScene'),  # noqa: E501
...
class GetPlanningScene_Event(metaclass=Metaclass_GetPlanningScene_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<appleproj_interfaces/GetPlanningScene_Request, 1>',
        'response': 'sequence<appleproj_interfaces/GetPlanningScene_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['appleproj_interfaces', 'srv'], 'GetPlanningScene_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['appleproj_interfaces', 'srv'], 'GetPlanningScene_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from appleproj_interfaces.srv import GetPlanningScene_Request
    ...
    def response(self, value):
        if self._check_fields:
            from appleproj_interfaces.srv import GetPlanningScene_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_GetPlanningScene(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'appleproj_interfaces.srv.GetPlanningScene')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from appleproj_interfaces.srv import _get_planning_scene
...
class GetPlanningScene(metaclass=Metaclass_GetPlanningScene):
    from appleproj_interfaces.srv._get_planning_scene import GetPlanningScene_Request as Request
    from appleproj_interfaces.srv._get_planning_scene import GetPlanningScene_Response as Response
    from appleproj_interfaces.srv._get_planning_scene import GetPlanningScene_Event as Event
