...
bool appleproj_interfaces__msg__obstacle_proxy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("appleproj_interfaces.msg._obstacle_proxy.ObstacleProxy", full_classname_dest, 54) == 0);
  }
  appleproj_interfaces__msg__ObstacleProxy * ros_message = _ros_message;
  {  // obstacle_id
  ...
  {  // obstacle_class
    PyObject * field = PyObject_GetAttrString(_pymsg, "obstacle_class");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->obstacle_class = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of ObstacleProxy */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("appleproj_interfaces.msg._obstacle_proxy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObstacleProxy");
  ...
  {  // obstacle_class
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->obstacle_class);
    {
      int rc = PyObject_SetAttrString(_pymessage, "obstacle_class", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
