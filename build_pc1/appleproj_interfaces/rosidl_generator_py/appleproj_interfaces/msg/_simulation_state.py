...
class Metaclass_SimulationState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'appleproj_interfaces.msg.SimulationState')
            logger.debug(
    ...
    def STOPPED(self):
        ...
        return Metaclass_SimulationState.__constants['STOPPED']

    @property
    def INITIALIZING(self):
        """Message constant 'INITIALIZING'."""
        return Metaclass_SimulationState.__constants['INITIALIZING']

    @property
    def READY(self):
        """Message constant 'READY'."""
        return Metaclass_SimulationState.__constants['READY']

    @property
    def PLAYING(self):
        """Message constant 'PLAYING'."""
        return Metaclass_SimulationState.__constants['PLAYING']

    @property
    def PAUSED(self):
        """Message constant 'PAUSED'."""
        return Metaclass_SimulationState.__constants['PAUSED']
