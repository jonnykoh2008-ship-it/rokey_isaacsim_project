...
bool appleproj_interfaces__msg__inspection_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("appleproj_interfaces.msg._inspection_image.InspectionImage", full_classname_dest, 58) == 0);
  }
  appleproj_interfaces__msg__InspectionImage * ros_message = _ros_message;
  {  // header
  ...
  {  // frame_index
    ...
    ros_message->frame_index = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // total_frames
    ...
    assert(PyLong_Check(field));
    ros_message->total_frames = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // image
...
{
  /* NOTE(esteve): Call constructor of InspectionImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("appleproj_interfaces.msg._inspection_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InspectionImage");
  ...
  {  // frame_index
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->frame_index);
    {
