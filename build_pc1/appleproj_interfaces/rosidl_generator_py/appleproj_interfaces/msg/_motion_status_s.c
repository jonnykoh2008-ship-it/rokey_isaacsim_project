...
bool appleproj_interfaces__msg__motion_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("appleproj_interfaces.msg._motion_status.MotionStatus", full_classname_dest, 52) == 0);
  }
  appleproj_interfaces__msg__MotionStatus * ros_message = _ros_message;
  {  // header
...
PyObject * appleproj_interfaces__msg__motion_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("appleproj_interfaces.msg._motion_status");
