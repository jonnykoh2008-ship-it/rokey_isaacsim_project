...
static const _CheckpointEvent_type_support_symbol_names_t _CheckpointEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, appleproj_interfaces, msg, CheckpointEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, appleproj_interfaces, msg, CheckpointEvent)),
  }
};
...
{
  return &::appleproj_interfaces::msg::rosidl_typesupport_cpp::CheckpointEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, appleproj_interfaces, msg, CheckpointEvent)() {
  return get_message_type_support_handle<appleproj_interfaces::msg::CheckpointEvent>();
}
