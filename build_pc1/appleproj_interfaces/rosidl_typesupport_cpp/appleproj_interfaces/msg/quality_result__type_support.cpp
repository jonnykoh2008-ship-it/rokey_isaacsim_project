...
static const _QualityResult_type_support_symbol_names_t _QualityResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, appleproj_interfaces, msg, QualityResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, appleproj_interfaces, msg, QualityResult)),
  }
};
...
{
  return &::appleproj_interfaces::msg::rosidl_typesupport_cpp::QualityResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, appleproj_interfaces, msg, QualityResult)() {
  return get_message_type_support_handle<appleproj_interfaces::msg::QualityResult>();
}
