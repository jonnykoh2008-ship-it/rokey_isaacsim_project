...
#include "appleproj_interfaces/msg/detail/simulation_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = appleproj_interfaces::msg::SimulationState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const appleproj_interfaces::msg::SimulationState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<appleproj_interfaces::msg::SimulationState *>(
    untyped_ros_message);
...
{
  return &appleproj_interfaces::msg::typesupport_fastrtps_cpp::_SimulationState__handle;
}
