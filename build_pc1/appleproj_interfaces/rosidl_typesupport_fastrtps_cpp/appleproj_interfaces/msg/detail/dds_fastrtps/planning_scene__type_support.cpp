...
#include "appleproj_interfaces/msg/detail/planning_scene__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const appleproj_interfaces::msg::ObstacleProxy &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const appleproj_interfaces::msg::PlanningScene & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.robot_base_pose,
    cdr);

  // Member: robot_tcp_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.robot_tcp_pose,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  appleproj_interfaces::msg::PlanningScene & ros_message)
{
  // Member: header
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.robot_base_pose);

  // Member: robot_tcp_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.robot_tcp_pose);
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        appleproj_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_ObstacleProxy(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = appleproj_interfaces::msg::PlanningScene;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        appleproj_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ObstacleProxy(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const appleproj_interfaces::msg::PlanningScene *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<appleproj_interfaces::msg::PlanningScene *>(
    untyped_ros_message);
...
{
  return &appleproj_interfaces::msg::typesupport_fastrtps_cpp::_PlanningScene__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, appleproj_interfaces, msg, PlanningScene)() {
  return &appleproj_interfaces::msg::typesupport_fastrtps_cpp::_PlanningScene__handle;
}
