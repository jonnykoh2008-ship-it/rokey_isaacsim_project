...
#include "appleproj_interfaces/msg/detail/motion_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const appleproj_interfaces::msg::MotionStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  appleproj_interfaces::msg::MotionStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = appleproj_interfaces::msg::MotionStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_appleproj_interfaces
max_serialized_size_key_MotionStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const appleproj_interfaces::msg::MotionStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<appleproj_interfaces::msg::MotionStatus *>(
    untyped_ros_message);
...
static size_t _MotionStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotionStatus(full_bounded, is_plain, 0);
...
{
  return &appleproj_interfaces::msg::typesupport_fastrtps_cpp::_MotionStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, appleproj_interfaces, msg, MotionStatus)() {
  return &appleproj_interfaces::msg::typesupport_fastrtps_cpp::_MotionStatus__handle;
}
